		...
		<ul className="ace-responsive-menu">
			<li className="visible_list dropitem">
				{/*<a className="list-item" href="#">
					<span className={topMenu == 'home' ? 'title menuActive' : 'title'}>Domů</span>
			...
			<li className="megamenu_style dropitem">
				<a className="list-item" href="#">
					<span className={topMenu == 'listing' ? 'title menuActive' : 'title'}>Nabídky</span>
					<span className="arrow"></span>
				</a>
			...
			<li className="visible_list dropitem">
				<a className="list-item" href="#">
					<span className={topMenu == 'property' ? 'title menuActive' : 'title'}>Nemotitosti</span>
					<span className="arrow"></span>
				</a>
				<ul className="sub-menu">
					{propertyItems.map((item, index) => (
						<li key={index} className="dropitem">
							<a href="#">
								<span className={submenu == item.label ? 'title menuActive' : 'title'}>{item.label}</span>
								<span className="arrow"></span>
							</a>
							<ul className="sub-menu">
			...
			<li className="visible_list dropitem">
				<a className="list-item" href="#">
					<span className={topMenu == 'blog' ? 'title menuActive' : 'title'}>Blog</span>
					<span className="arrow"></span>
				</a>
				<ul className="sub-menu">
			...
			<li className="visible_list dropitem">
				<a className="list-item" href="#">
					<span className={topMenu == 'pages' ? 'title menuActive' : 'title'}>Stránky</span>
					<span className="arrow"></span>
				</a>
				<ul className="sub-menu">
