...
const Funfact = () => {
	const funFacts = [
		{ number: 400, text: 'Makléřů' },
		{ number: 200, text: 'Lokací po celém světě' },
		{ number: 1000, text: 'Pozemků' },
...
const CounterWithAnimation = ({ end }) => {
	...
	return (
		<span ref={countRef}>
			{inView ? <CountUp end={end} duration={2} separator="," formattingFn={formatNumber} /> : '0'}
		</span>
	)
}
