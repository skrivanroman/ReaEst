...
const HeroContent = () => {
	...
	const tabs = [
		{ id: 'buy', label: 'Koupit' },
		{ id: 'rent', label: 'Pronajmout' },
		{ id: 'sold', label: 'Prodáno' },
	]
	...
	return (
		<div className="advance-style2 mt80 mt0-md mb60 mx-auto" data-aos="fade-up">
			...
			<div className="tab-content">
				{tabs.map((tab) => (
					<div className={`${activeTab === tab.id ? 'active' : ''} tab-pane`} key={tab.id}>
							...
							<div className="row align-items-center justify-content-start justify-content-md-center">
									...
									<div className="advance-search-field position-relative text-start bdrr1 bdrrn-sm bb1-sm">
										<form className="form-search position-relative">
											<div className="box-search">
												...
												<input className="form-control " type="text" name="search" placeholder={`Hledat`} />
											</div>
										</form>
									</div>
								</div>
								...
								<div className="col-md-4 col-lg-3">
									<div className="d-flex align-items-center justify-content-start justify-content-md-center mt-3 mt-md-0">
										...
										>
											<span className="flaticon-settings" /> Pokročilé
										</button>
										<button
